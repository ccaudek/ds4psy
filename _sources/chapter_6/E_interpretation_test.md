...
````{solution} ex-significato-test-5
:class: dropdown
:label: sol-significato-test-5
...
```{solution} ex-significato-test-9
:class: dropdown
:label: sol-significato-test-9
...
```{solution} ex-significato-test-11
:class: dropdown
:label: sol-significato-test-11
